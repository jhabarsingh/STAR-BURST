	...
	<div id="teammodel">
		...
		<div class="container" v-if="toogle">
				<div class="row">
                  ...
                  <input type="text" class="form-control rels" :value="id >=0 ? allData[id].name: ''" aria-label="Username" aria-describedby="basic-addon1" ref="name" >
                </div>
                <div class="input-group mb-3 mt-2">
                  <div class="input-group-prepend">
                    <span class="input-group-text label" id="basic-addon1">Designation</span>
                  </div>
                  <input type="text" class="form-control rels" :value="id >=0 ? allData[id].designation: ''" aria-label="Username" aria-describedby="basic-addon1" ref="designation" >
                </div>
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text label" id="basic-addon1">Image Url</span>
                  </div>
                  <input type="text" class="form-control rels" :value="id >=0 ? allData[id].url: ''" aria-label="Username" aria-describedby="basic-addon1" ref="url" >
                </div>
                <div style="text-align:center;">
