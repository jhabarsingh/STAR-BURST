					...
					<div class="col">
						<div class="jumbotron pop-jumbo con" style="font-family: ubuntu;">
							...
							<div class="input-group mb-3 mt-2">
							  ...
							  <input type="text" class="form-control rels" :value="id >=0 ? allEvents[id].title: ''" aria-label="Username" aria-describedby="basic-addon1" ref="title">
							</div>
							<div class="input-group mb-3 about">
							  <div class="input-group-prepend">
							    <span class="input-group-text label">About</span>
							  </div>
							    <textarea class="form-control rels" aria-label="With textarea" :value="id>=0 ? allEvents[id].about: ''" ref="about" ></textarea>
							  </div>
